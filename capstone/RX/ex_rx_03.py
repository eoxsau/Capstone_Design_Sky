...
class ex_rx_03(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ex_rx_03")
        ...
        # 추가
        font_size_px = 24
        self._qtgui_freq_sink_x_0_win.setStyleSheet(f"""
            * {{
                font-size: {font_size_px}px;
            }}
        """)
...
def main(top_block_cls=ex_rx_03, options=None):
