...
# === 도약 주파수 생성 함수 [동적] ===
def generate_group_frequencies_3(tod, trial, key):  # 주파수 위치 생성 함수
    z = get_phase_from_aes(tod, trial, 0, key, offset=0)
    norm = generate_complex_phase(z)
...
# === 최종 테이블 ===
def final_table_gen(trials, save_csv=True, filename="test_result_modify/Ver5_modify.csv"):
    key = AES_KEY
...
if __name__ == "__main__":
    ...
    final_table = final_table_gen(10000)
